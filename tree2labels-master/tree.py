...
#                break
            ...
            for i in range(explore_up_to):   
                ...
                if leaves_paths[j][i] == leaves_paths[j+1][i]:
                    ...
                    #relative_ni = ni - previous_ni#relative
                    relative_ni = ni#absolute              
                    if binarized:
	...
	for i,label in enumerate(sequence):
            splitter=label.split("_")
            next=i+1
            if len(splitter)==2:
                if splitter[1]=="PP-G":
                    sequence[i]="PP-G"  #to get it back add 1 to next number of label
                elif splitter[1]=="PP":
                    sequence[i] = "PP" #to get it back add 1 to next number of label
                elif splitter[1]=="PP-SUBJ":
                    sequence[i] = "PP-SUBJ" #to get it back add 1 to next number of label
                elif splitter[1] == "PP-OBJ":
                    sequence[i] = "PP-OBJ"  # to get it back add 1 to next number of label
                elif splitter[1]=="PP-OBL":
                    sequence[i] = "PP-OBL" #to get it back add 1 to next number of label
                elif splitter[1]=="PP-PDL":
                    sequence[i] = "PP-PDL" #to get it back add 1 to next number of label
                elif splitter[1]=="PP-POF":
                    sequence[i] = "PP-POF" #to get it back add 1 to next number of label
                elif splitter[1]=="VC":
                    sequence[i] = "VC" #to get it back add 1 to prvious number of label
                elif splitter[1]=="VC-VALA":
                    sequence[i] = "VC-VALA" #to get it back add 1 to prvious number of label
                elif splitter[1]=="DMP":
                    sequence[i] = "DMP" #to get it back add 1 to next number of label        
	return sequence    
